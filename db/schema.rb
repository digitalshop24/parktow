...
ActiveRecord::Schema.define(version: 20160520143702) do
  ...
  add_index "parkings", ["device_id"], name: "index_parkings_on_device_id", using: :btree

  add_foreign_key "parkings", "devices"
end
